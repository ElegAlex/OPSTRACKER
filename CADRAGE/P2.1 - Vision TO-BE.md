...
> **MANIFESTE** : _"Chaque opération IT pilotée, pas subie. Chaque technicien équipé, pas perdu. Chaque CPAM autonome, pas dépendante."_

**Le Pitch d'Ascenseur (Format Geoff Moore)** :

> _"Pour les **gestionnaires d'opérations IT des CPAM** qui ont besoin de **piloter des opérations de masse (migrations, déploiements, renouvellements) sans passer plus de temps à consolider qu'à piloter**, OpsTracker est une **application de pilotage d'opérations terrain** qui apporte **une source unique de vérité avec dashboards temps réel, checklists protégées et documentation contextuelle**. Contrairement aux **fichiers Excel ad hoc** qui dispersent les données et forcent la consolidation manuelle, ou aux **solutions enterprise** (Juriba, ReadyWorks) qui coûtent plus de 50k€/an, nous offrons **une solution simple, souveraine, conforme RGAA et immédiatement adoptable — sans formation, sans cloud US, sans budget prohibitif, et 100% compatible SILL**."_
...
|**Adoption initiale**|Nombre de CPAM utilisatrices actives|4 CPAM (37, 75, 77, 93)|**T+3 mois**|
|**Réutilisation**|Nombre de campagnes créées|≥ 2 campagnes / CPAM|T+6 mois|
...
**Le problème** : Dans le POC TAM, modifier une checklist écrasait tout le suivi existant. C'est un irritant identifié.
...
- [ ] **Import/Export CSV de configuration de campagne** (partage inter-CPAM) — P1.4
...
|**Pilote CPAM 92**|T+2 semaines|1 campagne réelle suivie via OpsTracker|
|**4 CPAM actives**|**T+3 mois**|CPAM 37, 75, 77, 93 avec au moins 1 campagne chacune|
