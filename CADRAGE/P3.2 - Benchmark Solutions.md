...
|**Hébergement**|Self-hosted on-premise CPAM|✅ OUI|
...
Les DPC sont la **référence fonctionnelle** du use case mais sont **totalement incompatibles** avec les contraintes CPAM (stack, langue, prix, RGAA).
...
**Verdict SaaS** : ⭐ **TOUS ÉLIMINÉS** — Cloud-only = incompatible self-hosted CPAM
