...
|---|---|:-:|
|**Stack technique**|Symfony (PHP) — contrainte Assurance Maladie|✅ OUI|
|**Hébergement**|Self-hosted on-premise Organisation|✅ OUI|
...
|Checklists multi-phases protégées|Must Have|P0 (leçon POC TAM)|
...
Les DPC sont la **référence fonctionnelle** du use case mais sont **totalement incompatibles** avec les contraintes Organisation (stack, langue, prix, RGAA).
...
**Verdict SaaS** : ⭐ **TOUS ÉLIMINÉS** — Cloud-only = incompatible self-hosted
...
|**POC validé**|Le POC TAM IDF prouve que le concept fonctionne|
...
|Checklists|Snapshot Pattern|Innovation (résout problème POC TAM)|
