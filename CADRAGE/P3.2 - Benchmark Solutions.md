...
|Checklists multi-phases protégées|Must Have|P0 (leçon POC initial)|
...
|**POC validé**|Le POC initial prouve que le concept fonctionne|
...
|Checklists|Snapshot Pattern|Innovation (résout problème POC initial)|
