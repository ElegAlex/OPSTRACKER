...
|~~#11~~|~~P4.2~~|~~Stratégie de backup PostgreSQL non détaillée~~|~~🟡 Mineur~~|✅ **Fermé** — Hors scope (backup CPAM existant §8.5)|
...
|Self-hosted CPAM 92|Docker Compose|✅ Respecté|
...
|Bundle AM Symfony non disponible|Moyenne|Moyen|Architecture standalone compatible|Dev|

### 4.2 Risques Fonctionnels

|Risque|Prob.|Impact|Mitigation|Owner|
|---|:-:|:-:|---|---|
|Adoption Karim (retour Excel)|Haute|Mortel|UX irréprochable + pilote CPAM 92|Product|
|Scope creep multi-CPAM|Moyenne|Fort|Périmètre MVP verrouillé, import/export config V1|Product|
|Résistance au changement|Moyenne|Moyen|Champions locaux par CPAM|Sponsor|
...
|#11|Backup PostgreSQL|**Hors scope**|Confié au backup quotidien CPAM existant (cf. P4.2 §8.5). Pas de config additionnelle requise.|
...
|3|Provisionner environnement Docker CPAM 92|Ops|J+5|Haute|
...
gantt
    ...
    Provisioning Docker CPAM 92       :a1, 2026-01-20, 5d
    ...
    section Milestone
    MVP Pilote CPAM 92                :milestone, 2026-03-31, 0d
```
