...
|~~#11~~|~~P4.2~~|~~Stratégie de backup PostgreSQL non détaillée~~|~~🟡 Mineur~~|✅ **Fermé** — Hors scope (backup existant §8.5)|
...
|Self-hosted Organisation|Docker Compose|✅ Respecté|
...
|Risque|Prob.|Impact|Mitigation|Owner|
|---|:-:|:-:|---|---|
|Adoption Karim (retour Excel)|Haute|Mortel|UX irréprochable + pilote Organisation|Product|
...
|3|Provisionner environnement Docker Organisation|Ops|J+5|Haute|
...
gantt
    ...
    Provisioning Docker Organisation       :a1, 2026-01-20, 5d
    ...
    section Milestone
    MVP Pilote Organisation                :milestone, 2026-03-31, 0d
```
