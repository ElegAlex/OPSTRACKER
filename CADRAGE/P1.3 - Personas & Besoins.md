...
|2.0|Janvier 2025|Ajout des personas Métier issus de P1.3bis (réunion CPAM)|
...
> **Note importante** : Dans certaines CPAM, une même personne peut cumuler plusieurs rôles (ex: un technicien senior qui fait aussi la gestion). L'interface doit permettre cette polyvalence sans friction.
...
> **Source** : P1.3bis — Réunion CPAM (janvier 2025)

### 1. Profil & Contexte

- **Qui est-ce ?** : Agent CPAM (PFS, back-office, médical, RH, etc.) dont le poste ou l'équipement va être impacté par une opération IT. Ce n'est PAS un informaticien, c'est un "client interne" de l'opération.
...
- **Objectifs clés** :
    - Disposer d'un outil pérenne et mutualisable entre CPAM
...
|**Latent**|Avoir un outil référençable SILL pour légitimité inter-CPAM|Could Have|
...
- **Cas d'usage identifié** : Lors de la migration DRSM, une personne non-manager mais connaissant bien les agents s'est occupée de toute la planification en sollicitant les managers.
...
- Maintenance simplifiée = pas de forks divergents entre CPAM
