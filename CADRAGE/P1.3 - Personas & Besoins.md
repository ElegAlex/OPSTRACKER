...
|2.0|Janvier 2025|Ajout des personas Métier issus de P1.3bis (réunion Organisation)|
...
> **Note importante** : Dans certaines Organisation, une même personne peut cumuler plusieurs rôles (ex: un technicien senior qui fait aussi la gestion). L'interface doit permettre cette polyvalence sans friction.
...
> **Source** : P1.3bis — Réunion Organisation (janvier 2025)
...
- **Objectifs clés** :
    - Disposer d'un outil pérenne et mutualisable entre Organisation
...
- **Cas d'usage identifié** : Lors de la Migration Pilote Alpha, une personne non-manager mais connaissant bien les agents s'est occupée de toute la planification en sollicitant les managers.
...
- Maintenance simplifiée = pas de forks divergents entre Organisation
