# P1.3bis - Recueil de Besoins Organisation (PV Réunion de Généricisation)
...
| **Animateur** | Alexandre (DSI Organisation - Nanterre)                                    |

### 1.1 Participants

| Nom           | Organisme | Rôle                          | Présence |
| ------------- | --------- | ----------------------------- | -------- |
| **Alexandre** | Organisation   | DSI / Développeur / Animateur | ✅        |
| **Laurent**   | Org. C   | DSI / Contributeur            | ✅        |
| **Thierry**   | Org. E   | Contributeur                  | ✅        |
| **Stéphane**  | Org. E   | Contributeur                  | ✅        |
| **Benjamin**  | Org. D   | Contributeur                  | ✅        |
| **Serge**     | Org. F   | Contributeur                  | ✅        |
...
L'application **TAM-RDV** a été développée pour la migration DRSM→Organisation. Cette application a fait ses preuves mais n'est pas générique/réutilisable en l'état. L'objectif est de la génériciser pour répondre aux besoins de plusieurs Organisation.

### 2.2 Objectifs de la réunion

1. Recueillir les besoins complémentaires des organisations utilisatrices
...
|---|---|
|**Qui**|Agent Organisation (PFS, back-office, médical, etc.) dont le poste/équipement va être impacté|
...
**Point technique** : La Org. B dispose déjà d'une brique similaire fonctionnant avec la carte agent. Possibilité d'export/intégration à évaluer.
...
**Contexte** : Divergence organisationnelle identifiée entre Organisation. Certaines préfèrent responsabiliser les agents (inscription autonome), d'autres préfèrent que les managers contrôlent (présentéisme, continuité de service).
...
**Référence technique** : La Org. D a déjà implémenté cette fonctionnalité sur une application de réunion.
...
|D3|Modèle Portail Applications Locales (Organisation éditeur, instances par organisation)|✅ Unanime|
...
| --- | ------------------ | ------------------------------------------- | ---------------------------------------- |
| 🆕  | **Agent Impacté**  | Salarié Organisation concerné par l'opération       | **CRITIQUE** — Simplicité maximale       |
...
|E3|Export configuration|Template CSV partageable entre Organisation|

### 7.4 Risques Identifiés

| #   | Risque                                       | Probabilité | Impact | Mitigation                               |
| --- | -------------------------------------------- | ----------- | ------ | ---------------------------------------- |
| R1  | Divergence organisationnelle entre Organisation      | Haute       | Moyen  | Configurabilité maximale par campagne    |
...
|Organisation|Département|Référent(s)|Particularités|
|---|---|---|---|
...
|Multi-sites par organisation|✅ Conservé|
